...
export declare const generateTypeScriptDefinitions: (GraphQL: typeof GraphQLPackage, netlifyGraphConfig: NetlifyGraphConfig, schema: GraphQLSchema, enabledFunctions: ParsedFunction[], enabledFragments: Record<string, ParsedFragment>) => string;
export declare const generateFunctionsSource: (GraphQL: typeof GraphQLPackage, netlifyGraphConfig: NetlifyGraphConfig, schema: GraphQLSchema, operationsDoc: string, queries: Record<string, ExtractedFunction>, fragments: Record<string, ExtractedFragment>) => Promise<{
    clientSource: string;
...
export declare const generatePersistedFunctionsSource: (GraphQL: typeof GraphQLPackage, netlifyGraphConfig: NetlifyGraphConfig, netlifyJwt: string, siteId: string, schema: GraphQLSchema, operationsDoc: string, queries: Record<string, PersistedFunction>, fragments: Record<string, ExtractedFragment>, schemaId: string) => Promise<{
    clientSource: string;
    typeDefinitionsSource: string;
    functionDefinitions: ParsedFunction[];
