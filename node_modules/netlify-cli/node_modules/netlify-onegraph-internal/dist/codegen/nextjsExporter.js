...
exports.codegenModule = exports.generators = exports.version = exports.id = exports.nextjsFunctionSnippet = exports.computeOperationDataList = void 0;
...
var computeOperationDataList = function (_a) {
    var GraphQL = _a.GraphQL, query = _a.query, variables = _a.variables;
...
var asyncFetcherInvocation = function (GraphQL, operationDataList, pluckerStyle) {
    ...
    var invocations = operationDataList
        ...
        var pluckers = {
            get: ((_b = (_a = namedOperationData === null || namedOperationData === void 0 ? void 0 : namedOperationData.operationDefinition) === null || _a === void 0 ? void 0 : _a.variableDefinitions) === null || _b === void 0 ? void 0 : _b.map(function (def) {
                ...
                var withCoercer = coercerFor(GraphQL, def.type, "typeof req.query?." + name + " === 'string' ? req.query?." + name + " : req.query?." + name + "[0]");
...
exports.generators = [exports.nextjsFunctionSnippet];
