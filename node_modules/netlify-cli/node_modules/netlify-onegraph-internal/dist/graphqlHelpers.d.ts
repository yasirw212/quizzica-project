...
export declare function gatherVariableDefinitions(GraphQL: typeof GraphQLPackage, definition: OperationDefinitionNode): Array<[string, string]>;
export declare function typeScriptForGraphQLType(GraphQL: typeof GraphQLPackage, schema: GraphQLSchema, gqlType: GraphQLType): string;
export declare const guessVariableDescriptions: (GraphQL: typeof GraphQLPackage, schema: GraphQLSchema, operationDefinition: OperationDefinitionNode, variableNames: string[]) => Record<string, {
    usageCount: number;
    descriptions?: Set<string>;
}>;
export declare function typeScriptSignatureForOperationVariables(GraphQL: typeof GraphQLPackage, variableNames: Array<string>, schema: GraphQLSchema, operationDefinition: OperationDefinitionNode): string;
export declare function listCount(GraphQL: typeof GraphQLPackage, gqlType: any): number;
export declare function typeScriptDefinitionObjectForOperation(GraphQL: typeof GraphQLPackage, schema: GraphQLSchema, operationDefinition: OperationDefinitionNode | FragmentDefinitionNode, fragmentDefinitions: Record<string, FragmentDefinitionNode>): OutObject;
...
export declare const formInput: (GraphQL: typeof GraphQLPackage, schema: any, def: any) => string | null;
export declare const remixFormInput: (GraphQL: typeof GraphQLPackage, schema: any, def: any, path?: never[]) => string | null;
...
export declare const normalizeOperationsDoc: (GraphQL: typeof GraphQLPackage, operationsDoc: string) => string;
export declare const gatherHardcodedValues: (GraphQL: typeof GraphQLPackage, query: string) => [string, string | number][];
export declare const extractPersistableOperation: (GraphQL: typeof GraphQLPackage, doc: DocumentNode, operationDefinition: OperationDefinitionNode) => {
