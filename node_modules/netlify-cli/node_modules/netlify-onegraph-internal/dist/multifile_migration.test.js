...
var test = function () { return __awaiter(void 0, void 0, void 0, function () {
    var sourceGraphQLFilename, sourceGraphQLDirectory, schemaGraphQLFilename, legacySourceGraphQLFile, operationsPath, operationFiles, dirCont, emptyDocDefinitionNode, parsedDoc, schemaGraphQLFile, schema, _a, functions, fragments, netlifyGraphConfig, result, _b, clientSource, typeDefinitionsSource, sourcePath, typeDefinitionsSourcePath;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                sourceGraphQLFilename = "./tests/assets/netlifyGraphOperationsLibrary.graphql";
                sourceGraphQLDirectory = "./tests/assets/operations/";
                schemaGraphQLFilename = "./tests/assets/netlifyGraphSchema.graphql";
                legacySourceGraphQLFile = fs.existsSync(sourceGraphQLFilename) &&
                ...
                _a = index_1.NetlifyGraph.extractFunctionsFromOperationDoc(parsedDoc), functions = _a.functions, fragments = _a.fragments;
                netlifyGraphConfig = {
                ...
                result = index_1.NetlifyGraph.generateFunctionsSource(netlifyGraphConfig, schema, sourceGraphQLFile, functions, fragments);
                if (!result) {
...
test();
//# sourceMappingURL=multifile_migration.test.js.map